...
import { CalendarDays, Save, BookOpen, Moon, ThumbsUp, Edit, Trash, ChevronDown, ChevronUp, Mic, MicOff } from "lucide-react";
...
export default function Journal() {
  ...
  const toggleSpeechRecognition = () => {
    ...
    if (isListening) {
      recognitionRef.current.stop();
      setEntry(prevEntry => prevEntry + (prevEntry ? '\n\n' : '') + transcript);
      setTranscript('');
      setIsListening(false);
    } else {
            ...
            <Card className="backdrop-blur-md bg-white/10 border-white/20">
              <CardContent className="p-6 space-y-6">
                ...
                >
                  ...
                  {isListening ? 'Stop Recording' : 'Speak to Write'}
                </Button>

                {isListening && (
                  <div className="bg-white/10 rounded-lg p-4 space-y-2">
                    <p className="text-white/70 text-sm">Listening... Speak clearly</p>
